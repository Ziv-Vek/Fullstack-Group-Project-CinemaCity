...
var queryString = window.location.search; // Retrieve transferred movie data from the URL query parameter
...
var moviePageRenderer;

function main() {
  return __awaiter(this, void 0, void 0, function () {
    var allCinemas, allMovies;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          return [4
          /*yield*/
          , this.getData("cinemaData")];

        case 1:
          allCinemas = _a.sent();
          return [4
          /*yield*/
          , this.getData("movieData")];
