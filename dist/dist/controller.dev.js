...
function OnListDropdownClick(filterSelection, searchByField) {
  ...
  moviesAndCinemasManager.getMoviesArr; //TODO: open new search tab

  aliyaFunction();
} //


function MovieSearchFiltering(searchFields) {} // aliya
...
var moviesArr = []; // Fetch movie data from JSON -
...
function renderMovieCards(movies) {
  ...
  movies.forEach(function (movie) {
    ...
    movieScreenDuration.textContent = "Screen Duration: " + movie.screenDuration;
