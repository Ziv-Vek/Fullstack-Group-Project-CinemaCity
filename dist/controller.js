...
function renderMovieCards(movies) {
  ...
  movies.forEach(function (movie) {
    movieCardsHTML +=
      ...
      movie.image +
      '" />\n    </div>\n    <div class="movieDetails">\n      <h2 class="movieDetails__movieName">' +
      movie.name +
      '</h2>\n      <p class="movieDetails__movieDescription">' +
      movie.description +
      '</p>\n      <p class="movieDetails__genre">Genre: ' +
      movie.genre.join(", ") +
      '</p>\n      <p class="movieDetails__ageLimit">Age Limit: ' +
      movie.ageLimit +
      '</p>\n      <p class="movieDetails__screenDuration">Screen Duration: ' +
      movie.screenDuration +
      '</p>\n      <p class="movieDetails__premiere">Premiere: ' +
      movie.premiere +
      ...
      movie.uuid +
      '" onclick="transferMovieData(event, ' +
      movie.uuid +
      ')">MOVIE PAGE</a>\n    </div>\n  </div>';
  });
...
function populateMoviePage(movie) {
  document.querySelector("#movieImage").innerHTML =
...
var SearchHandler = /** @class */ (function () {
  ...
  SearchHandler.prototype.onLocationSelect = function (
    searchFilter,
    location,
    eve
  ) {
  ...
  SearchHandler.prototype.onMovieSelect = function (
    searchFilter,
    movieUuid,
    eve
  ) {
  ...
  SearchHandler.prototype.onDateSelect = function (
    searchFilter,
    dateTimeStamp,
    eve
  ) {
  ...
  SearchHandler.prototype.filterMoviesByDate = function (newDate) {
    ...
    (_a = this.selectedCinema) === null || _a === void 0
      ? void 0
      : _a.movieList.forEach(function (movieInCinema) {
...
var SearchFieldsRenderer = /** @class */ (function () {
  ...
  SearchFieldsRenderer.prototype.updateSearchTitle = function (
    searchFilter,
    location
  ) {
  ...
  SearchFieldsRenderer.prototype.updateDateSearchTitle = function (
    searchFilter,
    date
  ) {
    var selector = document.querySelector("." + searchFilter);
    selector.children[0].innerHTML =
      " " +
  ...
  SearchFieldsRenderer.prototype.updateGenreSearchTitle = function (
    searchFilter,
    genre
  ) {
    var selector = document.querySelector("." + searchFilter);
  ...
  SearchFieldsRenderer.prototype.populateDates = function (selectedCinema) {
    ...
    if (availableDatesLengh === 0) {
      ...
      for (var i = 0; i < availableDatesLengh; i++) {
        ...
        searchDateMenu.innerHTML +=
          "<li>\n        <a\n          class=\"dropdown-item\"\n          onclick=\"searchHandler.onDateSelect('search__dates-dropdown', '" +
          newDate +
          "', event)\"\n          >" +
  ...
  SearchFieldsRenderer.prototype.populateGenres = function (selectedCinema) {
    ...
    searchGenreMenu.innerHTML = availableGenres
      .map(function (genre) {
        return (
          "<li>\n        <a\n          class=\"dropdown-item\"\n          onclick=\"searchHandler.onGenreSelect('search__genre-dropdown', '" +
          genre +
          "', event)\"\n          >" +
          genre +
          "</a>\n      </li>"
  ...
  SearchFieldsRenderer.prototype.populateLocations = function (cinemas) {
    ...
    searchLocationMenu.innerHTML = cinemas
      .map(function (cinema) {
        return (
          "<li>\n        <a\n          class=\"dropdown-item\"\n          onclick=\"searchHandler.onLocationSelect('search__cinemas-dropdown', '" +
          cinema.cinemaName +
          "', event)\"\n          >" +
          cinema.cinemaName +
          "</a>\n      </li>"
  ...
  SearchFieldsRenderer.prototype.populateMovies = function (movies) {
    ...
    searchMoviesMenu.innerHTML = movies
      .map(function (movie) {
        return (
          "<li>\n        <a\n          class=\"dropdown-item\"\n          onclick=\"searchHandler.onMovieSelect('search__movies-dropdown', '" +
          movie.uuid +
          "', event)\"\n          >" +
          movie.name +
          "</a>\n      </li>"
